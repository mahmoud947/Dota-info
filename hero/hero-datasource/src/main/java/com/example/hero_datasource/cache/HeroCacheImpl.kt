...
import com.example.dero_datasource.cache.HeroDatabase
import com.example.hero_domain.Hero
import com.example.hero_domain.HeroRole
import comexamplederodatasource.cache.HeroDbQueries
...
class HeroCacheImpl(
    ...
    override suspend fun getHero(id: Int): Hero {
        return queries.getHero(id = id.toLong()).executeAsOne().toHero()
    }
